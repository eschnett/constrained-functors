...
instance Function a => Function (V.Vector a) where
  function = functionMap V.toList V.fromList

instance (Function a, U.Unbox a) => Function (U.Vector a) where
  function = functionMap U.toList U.fromList
